        ...
        <table>
            ...
            <c:forEach items="${donationlist}" var="donation">
                <tr>
                    ...
                    <td><c:out value="${donation.trackingDetails}" /></td>
                    <td>
                        <a class="accept-link" href='<c:url value="processdonationstatus?id=${donation.id}&trackingDetails=Started"></c:url>'>Started</a>
                        <a class="reject-link" href='<c:url value="processdonationstatus?id=${donation.id}&trackingDetails=InProgress"></c:url>'>In Progress</a>
                        <a class="reject-link" href='<c:url value="processdonationstatus?id=${donation.id}&trackingDetails=Arrived"></c:url>'>Arrived</a>
                    </td>
