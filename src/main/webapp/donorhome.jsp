 ...
 <!-- Sidebar Navbar -->
    <div class="navbar">
        ...
        <ul>
            ...
            <li><a href="makedonation"><i class="fas fa-donate"></i> Make a Donation</a></li>
    ...
    <div class="content">
        <div class="welcome-container">
            ...
            <p>Thank you for your generous contributions to ONECAUSE. Your support helps us make a difference!</p>
