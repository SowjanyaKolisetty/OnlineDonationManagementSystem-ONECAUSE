        ...
        <table>
            ...
            <c:forEach items="${donationlist}" var="donation">
                <tr>
                    ...
                    <td>
                        <a class="accept-link" href='<c:url value="processdonationstatus?id=${donation.id}&status=Accepted"></c:url>'>Accept</a>
                        <a class="reject-link" href='<c:url value="processdonationstatus?id=${donation.id}&status=Rejected"></c:url>'>Reject</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
